<div x-data="dropzone">
	<form x-show="State.uploadStart" action="/api/v0/media/upload" method="POST" enctype="multipart/form-data" class="flex flex-col p-8 bg-white rounded-lg gap-4 w-full md:w-96 h-dvh md:h-auto" @change="updateActions" @submit.prevent="uploadMedia"
	...
	<div x-show="State.uploadSuccess" class="flex flex-col p-8 bg-white rounded-lg gap-4 w-full md:w-96 h-dvh md:h-auto justify-center items-center"
